...
<div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
    ...
    <div class="onlyforchrome" style="margin-top:5px;text-align:center;color:#8a8a8a;margin-bottom:80px; font-size:.8em;line-height:1.2em;font-family: Georgia;"><a href="http://www.thecodepost.org/internet/play-hidden-t-rex-game-offline-chrome/" target="_blank"><strong></strong></a><a href="https://www.twitter.com/thecodepost" target="_blank"><strong></strong></a><br/></div>
	<div id="main-frame-notchrome" style="display:none; margin-top:50px;"><a href="https://www.google.com/chrome">here</a></div>
...
<h3 style="color:blue"align="center">I'm Munna Ahmed<br>main(String[] args) { System. out. println("Hello World!"); // Hello World! }}</h3>
